...
public class StringUtil {
    ...
    public static String[] splitAsPriceText(String s) {
        ...
        array[0] = new String(str, 0, l);
        if (l >= str.length) return array;

        int r = l + 1;
        while (r < str.length && str[r] != '.') {
            r++;
        }
        array[1] = new String(str, l, r - l);
        if (r >= str.length) return array;

        array[2] = new String(str, r, str.length - r);
        return array;
    }
}
